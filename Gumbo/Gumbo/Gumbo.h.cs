...
namespace Gumbo
{
    ...
    public struct GumboSourcePosition
    {
        ...
        public static readonly GumboSourcePosition kGumboEmptySourcePosition = new GumboSourcePosition();
    }
    ///**
    ...
    public struct GumboStringPiece
    {
        ...
        int length;
        int startAt;
        public GumboStringPiece(char[] originalData, int startAt, int len)
        {
        ...
        public static readonly GumboStringPiece kGumboEmptyString = new GumboStringPiece();
    }
